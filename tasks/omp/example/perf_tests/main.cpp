...
TEST(openmp_example_perf_test_const, test_openmp_task_run) {
...
TEST(openmp_example_perf_test_const, test_seq_task_run) {
  kurakin_m_monte_carlo_omp::Integral integral{
      .func_ = [](std::vector<double> x) { return x[0]; }, .bounds_ = {{-1, 1}}, .iterations_ = 1000000};
  std::vector<double> res(1, 0);
...
TEST(openmp_example_perf_test_dimension_1, test_openmp_task_run) {
  kurakin_m_monte_carlo_omp::Integral integral{.func_ = [](std::vector<double> x) { return x[0] + x[1] + x[2]; },
                                               .bounds_ = {{-1, 1}, {-1, 1}, {-1, 1}},
                                               .iterations_ = 1000000};
  std::vector<double> res(1, 0);
